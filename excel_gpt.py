...
st.set_page_config(page_title="Excel Chatbot", page_icon=":robot_face:")
...
class ChatApp:
    def __init__(self):
        ...
        bucket_name = 'excelgptembeddings'
        file_key = 'pickle_file_xlsx_06_06_23.pkl'
    ...
    def run(self):
        ...
        with st.sidebar:
            ...
            st.write("[Sample Zerodha Portfolio](https://onedrive.live.com/view.aspx?resid=4EE17E5D8ADF0FC7!36727&cid=4ee17e5d8adf0fc7&authkey=!AEkfwN6Ye1AHc4U&CT=1686121706958&OR=ItemsView)")
